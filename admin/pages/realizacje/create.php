...
if (isset($_POST['submit'])){
	if(isset($_FILES['image-file']) && !empty($_FILES['image-file']['name'])){
		...
		$target_dir = '../assets/img/realizations-category/';
		...
		if ($uploadOk == 0) {
			...
			if (move_uploaded_file($_FILES["image-file"]["tmp_name"], $target_file)) {
				...
				$result = $realizacje->Create_Cat($fileName, $post_title, $post_description, $post_short_description, $post_order);
...
<div class="col-md-12">
	<h4 class="page-title">
		Dodaj kategorię
		<small>
			Preferowany rozmiar zdjęcia: <?php echo REALIZATIONS_CATEGORY; ?>
		</small>
	</h4>
</div>
	...
	<div class="white-box">
		<form class="form-horizontal form-material" action="" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<div class="col-md-12">
					<textarea class="form-control form-control-line" name="ShortDescription" placeholder="Wpisz opis kategorii" rows="5">
						<?php if ($post_short_description != "") echo "value='{$post_short_description}'"; ?>
					</textarea>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-md-12">
					<textarea class="form-control form-control-line" name="Description" placeholder="Wpisz opis kategorii" rows="10">
						<?php if ($post_description != "") echo "value='{$post_description}'"; ?>
					</textarea>
				</div>
			</div>
			<div class="form-group">
