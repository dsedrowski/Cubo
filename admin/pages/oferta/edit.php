...
if (isset($_POST['submit'])){
	...
	$result = $oferta->Edit_Cat($post_id, $post_title, $post_description, $post_short_description, $post_order);
	...
	$oferta = $oferta->Get_Cat($post_id);

	$post_title = $oferta['Title'];
	$post_description = $oferta['Description'];
	$post_short_description = $oferta['ShortDescription'];
	$post_order = $oferta['OrderNo'];
}
